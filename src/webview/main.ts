import { provideVSCodeDesignSystem, vsCodeButton, vsCodePanels, vsCodePanelTab, vsCodePanelView, vsCodeTextField, vsCodeDivider, vsCodeBadge } from '@vscode/webview-ui-toolkit';
